"use strict";
/*
  levels.js now only has:
    - Farm
    - Bonus

  The Food/Industrial classes have been removed.
*/
// -----------------------------------------------------
// Farm Scene
// -----------------------------------------------------
class Farm extends Phaser.Scene {
    ...
    create() {
        ...
        this.tilesetNew = this.map.addTilesetImage("new-packed", "tilemap_tiles_new")
        ...
        this.groundLayer = this.map.createLayer("Ground-n-Platforms", [this.tilesetFarm, this.tileset, this.tilesetNew], 0, 0);
        this.decorationLayer = this.map.createLayer("Decoration", [this.tilesetFarm, this.tileset, this.tilesetNew], 0, 0);
    ...
    update() {
        ...
        if (Phaser.Input.Keyboard.JustDown(cursors.up) && this.jumpCount < 1) {
        ...
        // Next scene → go directly to the Bonus now (since Food/Industrial are removed)
...
//         this.welcomeText = this.add.text(50, 100, 'Welcome to the Bonus Level!', { fontSize: '12px', fill: '#000000' });
